                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 2),
                          Text(
                            purchase.stockReplenished
                                ? 'Entrou no estoque: ${purchase.stockProductName ?? purchase.itemName}'
                                : 'Não entrou no estoque',
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              color: purchase.stockReplenished
                                  ? AppColors.success
                                  : _mutedColor(context),
                              fontWeight: FontWeight.w900,
                              fontSize: 11,
...
class _PurchaseDialogState extends State<_PurchaseDialog> {
      ...
      content: SizedBox(
        ...
        child: ListView(
          children: [
            ...
            const SizedBox(height: 14),
            if (widget.purchase != null || !replenishStock) ...[
              TextField(
                        ...
                        if (replenishStock) ...[
                          ...
                          if (stockProducts.isEmpty)
                            Align(
                              alignment: Alignment.centerLeft,
                              child: Text(
                                'Nenhum produto ativo cadastrado no estoque. Cadastre o produto no estoque ou desligue a reposição automática.',
                                style: TextStyle(
                              ...
                              onChanged: (value) {
                                ...
                                setState(() {
                                  ...
                                  if (selectedProduct != null) {
                                    itemController.text = selectedProduct.name;
  ...
  void _save() {
    ...
    final purchase = SupplierPurchase(
      ...
      itemName: itemName,
      category: stockProduct?.category ?? selectedCategory,
      unit: stockProduct?.unit ?? selectedUnit,
      quantity: quantity,
      unitCost: unitCost,
